...
Partial Public Class DataSet1
    ...
    Partial Public Class OrdersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOrdersRow(ByVal CustomerID As String, ByVal EmployeeID As Integer, ByVal Freight As Decimal) As OrdersRow
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `CustomerID` = ?, `EmployeeID` = ?, `Freight` = ? WHERE ((`Or"& _ 
                "derID` = ?))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        OrderID, CustomerID, EmployeeID, Freight"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Orders"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        OrderID, CustomerID, EmployeeID, Freight"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Orders"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"W"& _ 
                "HERE       OrderID = :OrderID"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("OrderID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), Nothing, Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet1.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet1.OrdersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet1.OrdersDataTable = New DataSet1.OrdersDataTable()
        ...
        Public Overloads Overridable Function FillByOrderID(ByVal dataTable As DataSet1.OrdersDataTable, ByVal OrderID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataByOrderID(ByVal OrderID As Integer) As DataSet1.OrdersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(OrderID,Integer)
            Dim dataTable As DataSet1.OrdersDataTable = New DataSet1.OrdersDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet1.OrdersDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal CustomerID As String, ByVal EmployeeID As Global.System.Nullable(Of Integer), ByVal Freight As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal CustomerID As String, ByVal EmployeeID As Global.System.Nullable(Of Integer), ByVal Freight As Global.System.Nullable(Of Decimal), ByVal Original_OrderID As Integer) As Integer
            If (CustomerID Is Nothing) Then
